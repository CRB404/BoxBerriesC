(function($) {
  ...
  var emailCapture = firebase.database().ref('emails/strawberriesThree');
  var locationRecord = firebase.database().ref('location/strawberriesThree');
...
// _____________________________________________________________________________
  ...
  window.onload = function() {
    firebase.database().ref('location/strawberriesThree/val').once('value').then(function(snapshot) {
